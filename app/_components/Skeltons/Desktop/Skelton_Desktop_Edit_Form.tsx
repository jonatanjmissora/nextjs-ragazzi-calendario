  ...
  return (
    <div className="h-full w-full flex justify-center items-center">
          ...
          <div className="edit-form-container flex flex-col gap-4 min-w-80 card">
            ...
            <div className="input-main h-[42px]"><span className="size-4 loading loading-bars mx-2"></span></div>

            <div className="input-main"><span className="size-4 loading loading-bars mx-2"></span></div>
