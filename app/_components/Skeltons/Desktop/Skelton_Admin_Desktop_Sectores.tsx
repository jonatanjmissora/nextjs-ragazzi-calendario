...
export default function SkeltonAdminDesktopSectores() {
    return (
        ...
        <article className="table-width flex flex-col gap-0 items-center flex-1 mt-10">
            ...
            <div
                className={`badge-main w-1/2 bg-foreground25`}
                >Sectores Actuales
            </div>

            <div
                className={`badge-main w-1/2`}
            >Sectores Constantes
            </div>
            </div>
            ...
            RUBROS.map(rubro =>
                ...
                <div key={rubro} className="w-[90%] flex flex-col border-b border-foreground25 last:border-b-0 py-4">
