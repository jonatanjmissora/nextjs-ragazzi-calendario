...
export default function AdminRealizadoAction({ realizado, dialogRef }: { realizado: PagoType, dialogRef: React.RefObject<HTMLDialogElement | null> }) {
  ...
  return (
    <div className='flex justify-around items-center gap-1'>
      ...
      <AdminRealizadoDeleteModal realizado={realizado} dialogRef2={dialogRef} />
    </div>
  )
}
